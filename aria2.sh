...
download_path="/home/pi/Aria2/downloads"
...
Set_aria2_vim_conf() {
 ...
 ${Green_font_prefix}4.${Font_color_suffix} nano 详细使用教程：${Green_font_prefix}https://www.vvhan.com/linux-nano.html${Font_color_suffix}
...
echo && echo -e " Aria2 一键安装管理脚本 增强版 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix} by \033[1;35mVVHAN.COM\033[0m
